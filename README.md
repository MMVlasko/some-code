...
|---------------------------------|-----------------------------------------------------------------------------------------------|--------------|
| Власко Михаил Михайлович        | Разработал начальное ядро и основу проекта                                                    |          |
| Никитцев Антон Валерьевич       | Добавил поддержку гиперпараметров и работу с ними, weight decay, воспроизводимые эксперименты |       |
| Михайлов Александр Денисович    | Разработал мобильное приложение на .NET MAUI с API neuro.Core                                 |      |
| Жуховицкий Александр Дмитриеивч | Добавил поддержку свёрточных нейросетей и новых видов слоёв                                   |          |
